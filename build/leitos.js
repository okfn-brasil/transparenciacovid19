...
function valueChange(latest, previous, column, upIsGood) {
  var valLatest = Math.round(latest[column] * 1000) / 10;
  ...
  if (valLatest === valPrevious) {
    ...
    return "<span class=\"".concat(upIsGood ? 'change-bad' : 'change-good', "\">&#9660;</span>");
  }
}

function generateSelect(region) {
  var regions = ["Brasil", "Centro-Oeste", "Nordeste", "Norte", "Sudeste", "Sul"];
...
function sectionTitle(title) {
  return "<div class=\"row mt4\">\n    <div class=\"col-xs-12\">\n      <h2 class=\"t6 bb\">".concat(title, "</h2>\n    </div>\n  </div>");
}